...
router.post("/", async (req, resppppp) => {
    ...
    const { uniqueId, otherUserID, sessionId, streamId, token } = req.body;
    ...
    const newNotification = {
        ...
        data: {
            title: `${matchedResultAuthed.firstName} is calling you for the in-app compeititon round!`,
        ...
        from: uniqueId,
        link: "competition-video-calling"
    };
